...
const AddChapter = (props)=> {
 ...
 const [arrnames , setNames] = React.useState([])
              ...
              <Card>
                 <CardHeader color="primary">
                    <h2 className={classes.cardTitleWhite}>Bulk Upload</h2>
                      <h3 className={classes.cardCategoryWhite}>Add Chapters</h3>
                  </CardHeader>
                  <CardBody>
                  {arr.map((file , index)=> 
                     <GridContainer>
...
AddChapter.propTypes ={
  ...
  export default connect(mapStateToProps, {addChapterFile, 
    UploadBulk , 
     clearMybooks , 
    clearCategories,  
    clearSubcategories , 
    clearSubbooks})(AddChapter);